> **ARCHIVED — superseded by [definitions.md](definitions.md) on 2026-08-18.**
>
> This is the pre-rework glossary, 149 terms, kept for comparison while the simplified block
> model is worked through. **It is not canonical and nothing may be built from it.** Where it
> disagrees with definitions.md, definitions.md is right. The words it retired — *element form*,
> *proxy*, *set*, *kind*, *annotation*, *tie*, *membership*, *node* — are listed under
> *What was retired* in the new file, with what replaced each.
