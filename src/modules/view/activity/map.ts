/** The activity's gesture map and the adjustments it accepts.
 *
 *  A plane like the block diagram: place cards and groups, relate for order,
 *  create an action. No interface / wall — a behavior layer holds refs, not
...
/** Whether this activity accepts the adjustment. */
