 ...
 *
 *  Both axes are the layer's blocks and proxies — the same objects a table
...
import { blocksOf, edgesIn, isProxy, nameOf, typeName } from "../../../graph/fold";
import type { Edge, Element, Graph } from "../../../graph/types";

/** One label on an axis: a block or a proxy in the open layer. */
...
/** Both axes and every cell — N×N over the layer's blocks and proxies. */
